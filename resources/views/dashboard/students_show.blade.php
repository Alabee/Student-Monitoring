...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="/student/search" method="post">
    	{{ csrf_field() }}
      <input class="form-control mr-sm-2" type="search" placeholder="Search for student" aria-label="Search" name="search_item">
		...
		@if(count($students)>0)
			@foreach($students as $student)
				<tr>
					...
					<td><a class="btn btn-primary" href="/student/edit/?q={{$student->reg_no}}">Edit</a></td>
				</tr>
			@endforeach
		@endif
	</table>
